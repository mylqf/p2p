var option = {};
option.url = {
	'api_admin' : '/p2p_action/admin/',
	'api_account' : '/p2p_action/account/',
	'api_user' : '/p2p_action/user/',
	'api_accountrecord' : '/p2p_action/accountrecord/',
	'api_product' : '/p2p_action/product/',
	'api_creditor' : '/p2p_action/creditor/',
	'api_match' : '/p2p_action/matchManagement/',
	'api_message' : '/p2p_action/',
	'api_UsersFunds' : '/p2p_action/UsersFunds/'
};
option.header = {
	'headers' : {
				...
				function($http) {
					return {
						...
						getProductList : function() {
							...
							// /itcast_p2p_action/product/findAllProduct
						},

						getProductById : function($str) {
							return $http.post(option.url.api_product
									+ 'findProductById', $str, option.header);
							// /itcast_p2p_action/product/findProductById
						},
						// 根据产品来获取利率信息
